    ...
    return (
        <Fragment>
            <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                viewBox="0 0 280 180" className="enablebackground">
                        <g transform="translate(40.000000, 35.000000)">
                            <g transform="translate(30.000000, 0.000000)">
                                <path className="st0" d="M134.3,47.5c-6-6.1-14.3-10-23.6-10c-8,0-14.9,2.8-21,7.7c-2.7,2.1-5.4,4.6-8.9,8
                                ...
                                <path className="st1" d="M53.7,44.4c-5.9-4.4-12.5-6.9-19.9-6.9c-9.3,0-17.6,3.8-23.6,10c-12.8,13.1-12.7,34.1,0.5,47
                                ...
                                <path className="st2" d="M114.2,30.1C108,12.8,91.5,0.4,72.2,0.4c-22.3,0-40.7,16.3-44,37.5c1.8-0.3,3.6-0.4,5.5-0.4
            ...
            <h3 className="text-secondary text-center">ProfEdu Cloud</h3>
        </Fragment>
    );
}